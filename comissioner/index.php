...
echo "<tr><td>".$row['sender']."</td> <td>".$row['message']."</td> <td>".$row['date']."</td> <td><a href='read.php?id=".$row['id']."'>read</a></td></tr>";
}
echo "</table>";
}
else{
  echo "<font style='color:red;font-size:20px;'>no new inbox message!</font>";
}
