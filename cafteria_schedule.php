...
<body>
    ...
    <img src="log1.png" style="width: 100%; height: 150px ; box-shadow: 0px 0px 10px 0px green; border-radius: 10px; margin-top: 2px;">
    <nav>
...
<table class="table table-bordered ">
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;"></td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;"> About BAsssosa Zone</td>
...
$report=mysqli_num_rows($query);
if ($report>0) {
    echo "<table class='table table-bordered' style='margin-top:20px;'><tr><th>Time</th> <th>Monday</th> <th>Tusday</th> <th>Wednesday</th> <th>Thursday</th> <th>Friday</th> <th>Saturday</th> <th>Sunday</th></tr>";
while ($row=mysqli_fetch_array($query)) {
   echo "<tr><td>".$row['eating_time']."</td> <td>".$row['monday']."</td> <td>".$row['tusday']."</td> <td>".$row['wednsday']."</td> <td>".$row['thursday']."</td> <td>".$row['friday']."</td> <td>".$row['saturday']."</td> <td>".$row['sunday']."</td></tr>";
}
echo "</table>";
}
else{
