...
<table class="table table-bordered ">
    ...
    <td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">All About Assosa Zone  Prison </td>
...
?>)</a></li><br>
    ...
    <a href="assosazprison@gmail.com"><img src="email.jpg" alt=""width="35%" height="29%"></a><br>&nbsp;&nbsp;<br>
    <a href="https://www.facebook.com/ASOZONEPRISON/?modal=admin_todo_tour"><img src="fb.png" alt="" width="34%" height="25%"/></a> <br>&nbsp;&nbsp;<br>
    <a href="https://www.yahoo.com"><img src="yahoo.png" alt=""width="34%" height="35%"/></a><br>&nbsp;&nbsp;<br>
  </td>  
    
  <td colspan="6" class="text-justify" style="font-size: 14px; width: 300px;"> Address:አሶሳ ዞን ማረሚያ, 3G2P+594<p> Phone
057 775 0300 <p> E-mail assosazprison@gmail.com</p></p><br>
            <img src="tasari.jfif" width="100%"></td> 

            <td style="width: 300px;" class="text-justify" colspan="2">
       <table class="table table-bordered table-condensed"><tr><td><a href="https://www.facebook.com/ASOZONEPRISON/?modal=admin_todo_tour"><span style="color: black; font-size: 20px;"></span><img src="fb.png" width="50px;"></td><td><center><font><br><br>https://www.facebook.com/ASOZONEPRISON/?modal=admin_todo_tour</font></center></td></tr>
<tr><td><a href="assosazprison@gmail.com"><span style="color: black; font-size: 20px;"></span><img src="email.jpg" width="50px;"></td> <td><br><br>assosazprison@gmail.com</td></tr>
<tr><td><img src="phone.png" width="50px;"></td> <td><br><br>+057 775 0300</td></tr>
       </table>
