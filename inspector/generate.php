...
<table class="table table-bordered ">
  ...
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">Do you know about Assosa Zone</td>
        ...
        <tr><td class="text-justify" style="font-size: 14px; width: 300px;"> Assosa Zone Located Benshangul/Gumuz, is one of the nine ethnic divisions (kililoch) of Ethiopia. It was previously known as Region 6.The region's capital is Assosa<br>
            <img src="../pri1.jpg" width="100%"></td> 
...
<?php 
$sql="select * from prisoner_information";
$query=mysqli_query($con,$sql);
$report=mysqli_num_rows($query);
if ($report>0) {
while ($row=mysqli_fetch_array($query)) {

  echo "<tr style='color:black; font-size:16px;'><td>".$row['serial_no']."</td> <td>".$row['fname']."</td> <td>".$row['mname']."</td> <td><a href='generated.php?id=".$row['serial_no']."' target='_blank'>Generate</a></td></tr>";
}
}
else{
  echo "<font>data not store!</font>";
}
