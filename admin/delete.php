...
while ($row=mysqli_fetch_array($query)) {
  ...
  echo "<tr><td>".$row['serial_no']."</td> <td>".$row['username']."</td> <td>".$row['account_type']."</td> <td><a href='deleted.php?id=".$row['serial_no']."' onclick='play()'>delete</a></td></tr>";
}
}
else{
