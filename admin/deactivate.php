...
<table class="table table-bordered ">
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        ...
        <tr><td class="text-justify" style="font-size: 14px; width: 300px;">  BAssosa Zone located in  Benshangul/Gumuz, is one of the 11 ethnic divisions (kililoch) of Ethiopia. It was previously known as Region 6.The region's capital is Assosa and Prison also here <br>
            <img src="../deact.png" width="100%"></td> 
...
while ($row=mysqli_fetch_array($query)) {
  ...
  echo "<tr><td>".$row['serial_no']."</td> <td>".$row['zone']."</td> <td>".$row['account_type']."</td> <td><a href='deactivated.php?id=".$row['id']."'>deactivate</a></td></tr>";
}
}
else{
