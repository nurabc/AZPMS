...
{
 if((time() - $_SESSION['last_time']) > 940) // Time in Seconds
 {
   ...
   echo "<script>alert('not registered')</script>";
     ...
     if ($query1) {
      ...
      echo "<script>alert('not registered')</script>";
       ...
       $sql1="INSERT INTO `policeofficer_information`(`fname`, `lname`, `serial_no`, `sex`, `age`, `zone`,`photo`) VALUES ('".$fname."','".$mname."','".$serial_no."','".$sex."','".$age."','".$zone."','".$photo."')";
     $query1=mysqli_query($con,$sql1);
     if ($query1) {
      echo "<script>alert('registered sucessfully')</script>";
     }
...
<p class="glyphicon glyphicon-hand-right">you can reate,delete,update,activate and deactivate</p>
  <br>
