...
echo "<tr><td>".$row['serial_no']."</td> <td>".$row['zone']."</td> <td>".$row['account_type']."</td> <td><a href='activated.php?id=".$row['id']." '>activate</a></td></tr>";
  ...
  echo "<font style='color:red; font-size:20px; margin-left:70px;'>no deactivated account!</font>";
}
